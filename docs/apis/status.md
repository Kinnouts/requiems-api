...
| ------------ | ---- | ------------------------------------------- |
| **planned**  | ⏳   | Not started yet, on roadmap                 |
| **partial**  | 🚧   | Partially implemented, in development       |
| **mvp**      | ✅   | Basic implementation live, production-ready |
| **complete** | ✨   | Full implementation with all features       |

## Categories

### [Entertainment](./entertainment/readme.md) - 15 endpoints
...
- [Dad Jokes](./entertainment/dad-jokes.md) - ⏳ planned
- [Day in History](./entertainment/day-in-history.md) - ⏳ planned
...
All 36 endpoints are currently planned. This category includes:

- BIN, Bitcoin, Commodity Price, Convert Currency, Crypto Price
- Earnings, Earnings Calendar, Earnings Call Transcript, ETF, Exchange Rate
- Gold Price, IBAN, Income Tax, Income Tax Calculator, Inflation
- Insider Trading, Interest Rate, LIBOR, Market Cap, Mortgage Calculator
- Mortgage Rate, Mutual Fund, Property Tax, Routing Number, S&P 500
- Sales Tax, Sales Tax Calculator, SEC, Stock Exchange, Stock Price
- SWIFT Code, Ticker, Unemployment, VAT
...
All 6 endpoints are currently planned. This category includes:

- Embeddings, Face Detect, Image to Text, Object Detection, Sentiment, Text
  Similarity

**Progress:** 0 live, 6 planned

### [Animals](./animals/readme.md) - 3 endpoints

All 3 endpoints are currently planned:

- Animals, Cats, Dogs

**Progress:** 0 live, 3 planned

### [Health / Wellness](./health-wellness/readme.md) - 7 endpoints

All 7 endpoints are currently planned. This category includes:

- Calories Burned, Cocktail, Covid-19, Exercises, Hospitals, Nutrition, Recipe

**Progress:** 0 live, 7 planned
...
All 9 endpoints are currently planned. This category includes:

- Aircraft, Airlines, Airports, Cars, Electric Vehicle, EV Charger, Helicopter,
  Motorcycles, VIN Lookup

**Progress:** 0 live, 9 planned
