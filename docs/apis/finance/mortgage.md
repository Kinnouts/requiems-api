...
```json
{
  "data": {
    ...
    "schedule": [
      { "month": 1, "payment": 1896.2, "principal": 271.2,  "interest": 1625.0,  "balance": 299728.8  },
      { "month": 2, "payment": 1896.2, "principal": 272.67, "interest": 1623.53, "balance": 299456.13 }
    ]
  },
  "metadata": {
...
Where `P` is the principal, `r` is the monthly rate (`annual_rate / 100 / 12`), and `n` is the total number of payments (`years × 12`).
