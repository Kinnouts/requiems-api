              ...
              schema: {
                ...
                properties: {
                  emails: {
                    ...
                    example: ["user1@example.com", "user2@tempmail.com"],
                  },
                },
                required: ["emails"],
                example: {
                  emails: ["user1@gmail.com", "user2@tempmail.com", "user3@guerrillamail.com"],
                },
              },
            },
          },
                    ...
                    data: {
                      ...
                      properties: {
                        ...
                        normalized: {
                          type: "string",
                          description:
                            "The canonical form of the address after normalization (lowercase, plus-tag removal, alias-domain resolution). Empty string when syntax is invalid",
                        },
                        domain: {
                          type: "string",
                          description:
                            "The domain part of the address (after @). Empty string when syntax is invalid",
                        },
                        suggestion: {
                          type: "string",
                          description:
